...
function SaveModal({ isOpen, content, closeModal, modalSaveEvent}){
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        <button type="button" className="btn btn-secondary" onClick={handleCheck}>취소</button>
                        <button type="button" className="btn btn-primary" name="save" onClick={handleCheck}>확인</button>
                    </div>
                </div>
            </div>
        </div>
